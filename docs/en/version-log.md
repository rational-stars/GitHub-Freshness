...
- The Chrome extension is now distributed separately through official channels. The public repository no longer includes its source code or local unpacked-install directory.
