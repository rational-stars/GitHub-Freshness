...
项目提供 Chrome 扩展版和 Tampermonkey 油猴脚本版。Chrome 扩展已经在 Chrome Web Store 正式上架，可从 [Chrome Web Store 安装 GitHub Freshness](https://chromewebstore.google.com/detail/github-freshness/eelkgplabammohbgakcoehekeefgahoj)。
...
Chrome 扩展源码不包含在本公开仓库中，请勿从非官方来源安装扩展文件。
...
公开仓库包含源码可用的油猴脚本和项目文档。Chrome 扩展独立发布，其源码不在本仓库公开。
